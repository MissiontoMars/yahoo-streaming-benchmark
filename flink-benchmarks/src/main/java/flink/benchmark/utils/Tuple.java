 ...
 * <p>
 * The fields in the tuples may be accessed directly a public
 * fields, or via position (zero indexed) {@link #getField(int)}.
 * </p>
 ...
 */
public abstract class Tuple implements java.io.Serializable, Cloneable {

    public static final int MAX_ARITY = 25;
    private static final long serialVersionUID = 1L;
    // BEGIN_OF_TUPLE_DEPENDENT_CODE
    // GENERATED FROM org.apache.flink.api.java.tuple.TupleGenerator.
    private static final Class<?>[] CLASSES = new Class<?>[]{Tuple3.class,
        Tuple8.class};
