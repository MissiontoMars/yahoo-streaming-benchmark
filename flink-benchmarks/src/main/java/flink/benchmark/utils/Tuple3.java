 ...
 *
 * <p>Warning: If you subclass Tuple3, then be sure to either <ul> <li> not add any new fields, or
 * </li> <li> make it a POJO, and always declare the element type of your DataStreams/DataSets to
 * your descendant type. (That is, if you have a "class Foo extends Tuple3", then don't use
...
public class Tuple3<T0, T1, T2> extends Tuple {
    ...
    public boolean equals(Object o) {
        ...
        @SuppressWarnings("rawtypes") Tuple3 tuple = (Tuple3) o;
