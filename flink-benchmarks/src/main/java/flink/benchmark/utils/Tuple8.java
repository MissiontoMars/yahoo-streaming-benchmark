 ...
 * that work with Tuples to reuse objects in order to reduce pressure on the garbage collector.</p>
 *
 * <p>Warning: If you subclass Tuple8, then be sure to either <ul> <li> not add any new fields, or
 * </li> <li> make it a POJO, and always declare the element type of your DataStreams/DataSets to
 * your descendant type. (That is, if you have a "class Foo extends Tuple8", then don't use
 * instances of Foo in a DataStream&lt;Tuple8&gt; / DataSet&lt;Tuple8&gt;, but declare it as
 * DataStream&lt;Foo&gt; / DataSet&lt;Foo&gt;.) </li> </ul></p>
 *
...
public class Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> extends Tuple {
     ...
     */
    public Tuple8(T0 value0, T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6,
                  T7 value7) {
        this.f0 = value0;
        this.f1 = value1;
        this.f2 = value2;
    ...
    public static <T0, T1, T2, T3, T4, T5, T6, T7> Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> of(
        ...
        return new Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>(value0, value1, value2, value3, value4,
    ...
    public Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> copy() {
        return new Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>(this.f0, this.f1, this.f2, this.f3,
            this.f4, this.f5, this.f6, this.f7);
    }
    ...
    public boolean equals(Object o) {
        ...
        @SuppressWarnings("rawtypes") Tuple8 tuple = (Tuple8) o;
    ...
    public String toString() {
        return "(" + StringUtils.arrayAwareToString(this.f0) + "," + StringUtils
            .arrayAwareToString(this.f1) + "," + StringUtils.arrayAwareToString(this.f2) + ","
            + StringUtils.arrayAwareToString(this.f3) + "," + StringUtils
            .arrayAwareToString(this.f4) + "," + StringUtils.arrayAwareToString(this.f5) + ","
            + StringUtils.arrayAwareToString(this.f6) + "," + StringUtils
